    ...
    >
      ...
      >
        <Box p="3" style={{ flex: 1, minHeight: 0, overflow: 'auto' }}>
          <Text size="1" color="gray" mb="2" style={{ fontStyle: 'italic' }}>
            Preview Area
          </Text>
          <Separator mb="3" />
              ...
              <Card>
                <Flex direction="column" gap="3" p="3">
                  ...
                  <Flex gap="2" align="center" wrap="wrap">
                    <Avatar src="" fallback="JD" size="1" color={accentColor} />
                    <Avatar src="" fallback="AB" size="2" color={accentColor} />
                    <Avatar src="" fallback="CD" size="3" color={accentColor} />
                    <Avatar src="" fallback="EF" size="4" color={accentColor} />
                    <Avatar src="" fallback="GH" size="5" color={accentColor} />
                  </Flex>
                </Flex>
              </Card>
