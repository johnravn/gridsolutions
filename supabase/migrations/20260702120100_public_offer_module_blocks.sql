-- Return pretty offer module content blocks in public_offer_get
...
COMMENT ON FUNCTION public.public_offer_get(text) IS
  'Returns full offer payload for public view by access token. Pretty modules include ordered content blocks.';
