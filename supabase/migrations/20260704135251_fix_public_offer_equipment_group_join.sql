-- Fix regression in public_offer_get: equipment items must join on offer_group_id,
-- not inventory group_id (oei.group_id refers to item_groups, not offer_equipment_groups).
