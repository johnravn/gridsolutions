-- Extend public_offer_get to return pretty offer modules for customer-facing view.
...
COMMENT ON FUNCTION public.public_offer_get(text) IS
  'Returns full offer payload for public view by access token. Includes pretty offer modules for customer presentation.';
