-- Add sales-deck narrative + hero media fields to pretty offer modules,
-- and optional intro text on job_offers for the public deck hero.

ALTER TABLE public.job_offers
  ADD COLUMN IF NOT EXISTS pretty_intro_text TEXT;
...
ALTER TABLE public.pretty_offer_modules
  ...
  ADD COLUMN IF NOT EXISTS hero_media_type public.pretty_module_media_type,
  ADD COLUMN IF NOT EXISTS hero_media_url TEXT,
  ADD COLUMN IF NOT EXISTS hero_media_caption TEXT;
